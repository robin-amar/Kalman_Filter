...
% # Script: https://scipy-cookbook.readthedocs.io/items/KalmanFiltering.html
% # by Andrew D. Straw
% 
% import numpy as np
...
x = -0.37727;                           %# truth value (typo in example at top of p. 13 calls this z)
z = normrnd(x, 0.1, sz);    %# observations (normal about x, sigma=0.1)
...
figure(2)
valid_iter = [2 : n_iter];                %# Pminus not valid at step 0
